                        ...
                        {showTrainingSheetItem ? (
                            <>
                                ...
                                <Flex className={styles.exercisesInputs} flexWrap="wrap" justifyContent="space-between" alignItems="center">
                                    <Box width={[1, 2 / 4]}>
                                        <div className={styles.inputLabel}>Nome do Exercício</div>
                                    ...
                                    <Box width={[1, 1 / 5]}>
                                        <div className={styles.inputLabel}>Séries</div>
                                    ...
                                    <Box width={[1, 1 / 5]}>
                                        <div className={styles.inputLabel}>Repetições</div>
                                    ...
                                    <Box width={[1]}>
                                        <div className={styles.inputLabel}>Link guia do exercício</div>
                                    ...
                                    <Box width={[1]}>
                                        <div className={styles.inputLabel}>Descreva o exercício</div>
